...
public class ReportDAOImpl {
	...
	public String FetchMetricsDataDatewise(String startDate, String endDate, String campaignId,String channel) {
		Connection connection = null;
		Statement preparedStatement = null;
		ResultSet rs = null;
		String QueryString = null;
	...
	//	JSONObject jo = new JSONObject();
		...
		try {
			...
			if (connection != null) {
				...
				out = new ObjectMapper().writeValueAsString(obj3);
			//	jo.put("data",obj1);
			}
	...
	public String FetchMetricsData(String startDate, String endDate, String campaignId, String channel,String aggregate) {
		Connection connection = null;
		Statement preparedStatement = null;
		ResultSet rs = null;
		String QueryString = null;
...
/*
				...
				{		
				if(campaignId.equals("all") || campaignId.equals(""))
				QueryString ="SELECT SUM(impression)AS impression,SUM(conversions)AS conversion, audience_segment FROM datawarehouse WHERE audience_segment != '' AND date between "
							+ "'"+startDate + "' AND '" + endDate + "' GROUP BY audience_segment";
				else
				QueryString ="SELECT SUM(impression)AS impression,SUM(conversions)AS conversion, cuberootcampaign_id, audience_segment FROM datawarehouse WHERE audience_segment != '' AND date between "
							+ "'"+startDate + "' AND '" + endDate + "' AND cuberootcampaign_id in ("+campaignId+")  GROUP BY cuberootcampaign_id,audience_segment";
				}
				}
				else{
					if(campaignId.equals("all") || campaignId.equals(""))
						QueryString ="SELECT SUM(impression)AS impression,SUM(conversions)AS conversion, audience_segment,channel FROM datawarehouse WHERE channel like '%"+channel+"%' and audience_segment != '' AND date between "
									+ "'"+startDate + "' AND '" + endDate + "' GROUP BY audience_segment,channel ";
						else
						QueryString ="SELECT SUM(impression)AS impression,SUM(conversions)AS conversion, cuberootcampaign_id, audience_segment,channel FROM datawarehouse WHERE channel like '%"+channel+"%' and audience_segment != '' AND date between "
	...
	*/			
				...
				if(aggregate.equals("true")){
				if(campaignId.equals("all") || campaignId.equals(""))
				QueryString ="SELECT SUM(impression)AS impression,SUM(clicks)AS clicks,SUM(conversions)AS conversion, audience_segment FROM datawarehouse WHERE audience_segment != '' AND date between "
							+ "'"+startDate + "' AND '" + endDate + "' GROUP BY audience_segment";
				else
				QueryString ="SELECT SUM(impression)AS impression,SUM(clicks)AS clicks,SUM(conversions)AS conversion,cuberootcampaign_id,audience_segment FROM datawarehouse WHERE audience_segment != '' AND date between "
							+ "'"+startDate + "' AND '" + endDate + "' AND cuberootcampaign_id in ("+campaignId+")  GROUP BY cuberootcampaign_id,audience_segment";
				}
				else{
					
					if(campaignId.equals("all") || campaignId.equals(""))
						QueryString ="SELECT SUM(impression)AS impression,SUM(clicks)AS clicks,SUM(conversions)AS conversion,campaign_id audience_segment FROM datawarehouse WHERE audience_segment != '' AND date between "
									+ "'"+startDate + "' AND '" + endDate + "' GROUP BY campaign_id,audience_segment";
						else
						QueryString ="SELECT SUM(impression)AS impression,SUM(clicks)AS clicks,SUM(conversions)AS conversion,cuberootcampaign_id,campaign_id,audience_segment FROM datawarehouse WHERE audience_segment != '' AND date between "
					...
					if(aggregate.equals("true")){
					   ...
					   if(campaignId.equals("all") || campaignId.equals(""))
						QueryString ="SELECT SUM(impression)AS impression,SUM(clicks)AS clicks,SUM(conversions)AS conversion, audience_segment,channel FROM datawarehouse WHERE channel like '%"+channel+"%' and audience_segment != '' AND date between "
									+ "'"+startDate + "' AND '" + endDate + "' GROUP BY audience_segment,channel";
						else
						QueryString ="SELECT SUM(impression)AS impression,SUM(clicks)AS clicks,SUM(conversions)AS conversion,cuberootcampaign_id,audience_segment,channel FROM datawarehouse WHERE channel like '%"+channel+"%' and audience_segment != '' AND date between "
									+ "'"+startDate + "' AND '" + endDate + "' AND cuberootcampaign_id in ("+campaignId+")  GROUP BY cuberootcampaign_id,audience_segment,channel";
					}
					else{
						
						 if(campaignId.equals("all") || campaignId.equals(""))
								QueryString ="SELECT SUM(impression)AS impression,SUM(clicks)AS clicks,SUM(conversions)AS conversion, campaign_id,audience_segment,channel FROM datawarehouse WHERE channel like '%"+channel+"%' and audience_segment != '' AND date between "
											+ "'"+startDate + "' AND '" + endDate + "' GROUP BY campaign_id,audience_segment,channel";
								else
								QueryString ="SELECT SUM(impression)AS impression,SUM(clicks)AS clicks,SUM(conversions)AS conversion,cuberootcampaign_id,campaign_id,audience_segment,channel FROM datawarehouse WHERE channel like '%"+channel+"%' and audience_segment != '' AND date between "
				...
				if(metric.equals("reach"))
				{
					if(channel.equals("all") || channel.equals(""))
					{
						...
						if(campaignId.equals("all") || campaignId.equals(""))
						QueryString ="SELECT SUM(impression)AS impression,SUM(reach)AS reach,SUM(conversions)AS conversion, audience_segment FROM datawarehouse WHERE audience_segment != '' AND date between "
									+ "'"+startDate + "' AND '" + endDate + "' GROUP BY audience_segment";
						else
						QueryString ="SELECT SUM(impression)AS impression,SUM(reach)AS reach,SUM(conversions)AS conversion,cuberootcampaign_id,audience_segment FROM datawarehouse WHERE audience_segment != '' AND date between "
									+ "'"+startDate + "' AND '" + endDate + "' AND cuberootcampaign_id in ("+campaignId+")  GROUP BY cuberootcampaign_id,audience_segment";
						}
							...
							if(campaignId.equals("all") || campaignId.equals(""))
								QueryString ="SELECT SUM(impression)AS impression,SUM(reach)AS reach,SUM(conversions)AS conversion,campaign_id, audience_segment FROM datawarehouse WHERE audience_segment != '' AND date between "
											+ "'"+startDate + "' AND '" + endDate + "' GROUP BY campaign_id,audience_segment";
								else
								QueryString ="SELECT SUM(impression)AS impression,SUM(reach)AS reach,SUM(conversions)AS conversion,cuberootcampaign_id,campaign_id,audience_segment FROM datawarehouse WHERE audience_segment != '' AND date between "
											+ "'"+startDate + "' AND '" + endDate + "' AND cuberootcampaign_id in ("+campaignId+")  GROUP BY cuberootcampaign_id,campaign_id,audience_segment";
					   ...
					   if(aggregate.equals("true")){
					   if(campaignId.equals("all") || campaignId.equals(""))
							QueryString ="SELECT SUM(impression)AS impression,SUM(reach)AS reach,SUM(conversions)AS conversion, audience_segment FROM datawarehouse WHERE channel like '%"+channel+"%' and audience_segment != '' AND date between "
										+ "'"+startDate + "' AND '" + endDate + "' GROUP BY audience_segment";
							else
							QueryString ="SELECT SUM(impression)AS impression,SUM(reach)AS reach,SUM(conversions)AS conversion,cuberootcampaign_id,audience_segment FROM datawarehouse WHERE channel like '%"+channel+"%' and audience_segment != '' AND date between "
					   				+ "'"+startDate + "' AND '" + endDate + "' AND cuberootcampaign_id in ("+campaignId+")  GROUP BY cuberootcampaign_id,audience_segment";
					   }
					   else{
						   
						   if(campaignId.equals("all") || campaignId.equals(""))
								QueryString ="SELECT SUM(impression)AS impression,SUM(reach)AS reach,SUM(conversions)AS conversion,campaign_id, audience_segment FROM datawarehouse WHERE channel like '%"+channel+"%' and audience_segment != '' AND date between "
											+ "'"+startDate + "' AND '" + endDate + "' GROUP BY campaign_id,audience_segment";
								else
								QueryString ="SELECT SUM(impression)AS impression,SUM(reach)AS reach,SUM(conversions)AS conversion,cuberootcampaign_id,campaign_id,audience_segment FROM datawarehouse WHERE channel like '%"+channel+"%' and audience_segment != '' AND date between "
						   				+ "'"+startDate + "' AND '" + endDate + "' AND cuberootcampaign_id in ("+campaignId+")  GROUP BY cuberootcampaign_id,campaign_id,audience_segment"; 
	...
	public String FetchDeviceImpData(String metric, String startDate, String endDate, String campaignId,String channel,String aggregate) {
		Connection connection = null;
		Statement preparedStatement = null;
		ResultSet rs = null;
		String QueryString = null;
	...
	for (int i = 0; i < report.size(); i++)
     {
       ...
       {	   
    	 ...
    	 accumulatedCountConversion = accumulatedCountConversion + (int)Double.parseDouble(report.get(i).getConversions()); 
         	        	   
         if(metric.equals("reach"))
       	 accumulatedCountmetric = accumulatedCountmetric + (int)Double.parseDouble(report.get(i).getReach()); 
       	 
         if(metric.equals("clicks"))
         accumulatedCountmetric = accumulatedCountmetric + (int)Double.parseDouble(report.get(i).getClicks()); 
       	 
         if(metric.equals("impressions"))
         accumulatedCountmetric = accumulatedCountmetric + (int)Double.parseDouble(report.get(i).getImpressions()); 
